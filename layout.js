        ...
        flexLines.forEach(items => {
            ...
            if (flexTotal > 0) {
                ...
                for (let i = 0; i < items.length; i++) {
                    let item = items[i];
                    itemStyle[mainStart, currentMain];
                    istemStyle[mainEnd] = itemStyle[mainStart] + mainSign * itemStyle[mainSize];
    ...
    flexLines.forEach(items => {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            if (itemStyle[crossSize] === null) {
                itemStyle[crossSize] = (align === 'stetch') ?
                    lineCrossSize : 0
            }
            ...
            if (align === 'center') {
                ...
                itemStyle[crossEnd] = itemStyle[crossStart] + crossSing * itemStyle[crossSize];
            }
